...
public class JoystickView extends View
    ...
    */
    ...
    /**
     * Interface definition for callback to be invoked when a Joystick view is released
     */
    public interface OnTouchReleasedListener {
        /**
         * Called when a Joystickview touch has been released.
         */
        void onTouchRelease();
    }
    ...
    */
    ...
    /**
     * Default behavior to pull down center center
     */
    private static final boolean DEFAULT_PULL_DOWN_CENTER = false;
    ...
    /**
     * Listener used to dispatch OnTouchReleased event
     */
    private OnTouchReleasedListener mIsReleased;
    ...
    /**
     * Register a callback to be invoked when this JoystickView's touch is released
     */
    public void setOnTouchReleasedListener(OnTouchReleasedListener isReleased) {
